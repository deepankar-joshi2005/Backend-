...
exports.logActivity = exports.activityLogger = void 0;
...
const getBusinessAction = (req, method, route, originalUrl) => {
    var _a, _b;
    ...
    if (routeLower.includes("/schools")) {
        if (method === "POST")
            return { action: "CREATED_SCHOOL", resourceType: "SCHOOL" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_SCHOOL", resourceType: "SCHOOL" };
        if (method === "DELETE")
            return { action: "DELETED_SCHOOL", resourceType: "SCHOOL" };
    }
    // Student management
    if (routeLower.includes("/students")) {
        if (method === "POST")
            return { action: "CREATED_STUDENT", resourceType: "STUDENT" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_STUDENT", resourceType: "STUDENT" };
        if (method === "DELETE")
            return { action: "DELETED_STUDENT", resourceType: "STUDENT" };
        if (routeLower.includes("bulk-upload"))
            return { action: "BULK_UPLOADED_STUDENTS", resourceType: "STUDENT" };
    }
    // Mentor management
    if (routeLower.includes("/mentors")) {
        if (method === "POST")
            return { action: "CREATED_MENTOR", resourceType: "MENTOR" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_MENTOR", resourceType: "MENTOR" };
        if (method === "DELETE")
            return { action: "DELETED_MENTOR", resourceType: "MENTOR" };
    }
    // School admin management
    if (routeLower.includes("/school-admins")) {
        if (method === "POST")
            return { action: "CREATED_SCHOOL_ADMIN", resourceType: "SCHOOL_ADMIN" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_SCHOOL_ADMIN", resourceType: "SCHOOL_ADMIN" };
        if (method === "DELETE")
            return { action: "DELETED_SCHOOL_ADMIN", resourceType: "SCHOOL_ADMIN" };
    }
    // Lead mentor management
    if (routeLower.includes("/lead-mentors")) {
        if (method === "POST")
            return { action: "CREATED_LEAD_MENTOR", resourceType: "LEAD_MENTOR" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_LEAD_MENTOR", resourceType: "LEAD_MENTOR" };
        if (method === "DELETE")
            return { action: "DELETED_LEAD_MENTOR", resourceType: "LEAD_MENTOR" };
    }
    // Super admin management
    if (routeLower.includes("/superadmins") || routeLower.includes("/admins")) {
        if (method === "POST")
            return { action: "CREATED_SUPER_ADMIN", resourceType: "SUPER_ADMIN" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_SUPER_ADMIN", resourceType: "SUPER_ADMIN" };
        if (method === "DELETE")
            return { action: "DELETED_SUPER_ADMIN", resourceType: "SUPER_ADMIN" };
    }
    // Module management
    if (routeLower.includes("/modules")) {
        if (method === "POST")
            return { action: "CREATED_MODULE", resourceType: "MODULE" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_MODULE", resourceType: "MODULE" };
        if (method === "DELETE")
            return { action: "DELETED_MODULE", resourceType: "MODULE" };
    }
    // Session management
    if (routeLower.includes("/sessions")) {
        if (method === "POST")
            return { action: "CREATED_SESSION", resourceType: "SESSION" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_SESSION", resourceType: "SESSION" };
        if (method === "DELETE")
            return { action: "DELETED_SESSION", resourceType: "SESSION" };
    }
    // Resource management
    if (routeLower.includes("/resources")) {
        if (method === "POST")
            return { action: "UPLOADED_RESOURCE", resourceType: "RESOURCE" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_RESOURCE", resourceType: "RESOURCE" };
        if (method === "DELETE")
            return { action: "DELETED_RESOURCE", resourceType: "RESOURCE" };
    }
    // Assessment management
    if (routeLower.includes("/assessments")) {
        if (method === "POST")
            return { action: "CREATED_ASSESSMENT", resourceType: "ASSESSMENT" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_ASSESSMENT", resourceType: "ASSESSMENT" };
        if (method === "DELETE")
            return { action: "DELETED_ASSESSMENT", resourceType: "ASSESSMENT" };
    }
    // Question bank
    if (routeLower.includes("/questions")) {
        if (method === "POST")
            return { action: "CREATED_QUESTION", resourceType: "QUESTION" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_QUESTION", resourceType: "QUESTION" };
        if (method === "DELETE")
            return { action: "DELETED_QUESTION", resourceType: "QUESTION" };
    }
    // Certificate management
    if (routeLower.includes("/certificates")) {
        if (method === "POST")
            return { action: "GENERATED_CERTIFICATE", resourceType: "CERTIFICATE" };
        if (method === "DELETE")
            return { action: "DELETED_CERTIFICATE", resourceType: "CERTIFICATE" };
    }
    // HRMS - Salary Structure
    if (routeLower.includes("/salary-structures")) {
        if (method === "POST")
            return { action: "CREATED_SALARY_STRUCTURE", resourceType: "SALARY_STRUCTURE" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_SALARY_STRUCTURE", resourceType: "SALARY_STRUCTURE" };
        if (method === "DELETE")
            return { action: "DELETED_SALARY_STRUCTURE", resourceType: "SALARY_STRUCTURE" };
    }
    // HRMS - Statutory Reports
    if (routeLower.includes("/statutory-reports")) {
        if (method === "POST" && routeLower.includes("/generate"))
            return { action: "GENERATED_STATUTORY_REPORT", resourceType: "STATUTORY_REPORT" };
    }
    // HRMS - Employees (Users in HRMS context)
    if (routeLower.includes("/users")) {
        if (method === "POST")
            return { action: "CREATED_EMPLOYEE", resourceType: "EMPLOYEE" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_EMPLOYEE", resourceType: "EMPLOYEE" };
        if (method === "DELETE")
            return { action: "DELETED_EMPLOYEE", resourceType: "EMPLOYEE" };
    }
    // HRMS - Attendance
    if (routeLower.includes("/attendance")) {
        if (method === "POST")
            return { action: "CREATED_ATTENDANCE", resourceType: "ATTENDANCE" };
        if (method === "PUT" || method === "PATCH")
            return { action: "UPDATED_ATTENDANCE", resourceType: "ATTENDANCE" };
        if (method === "DELETE")
            return { action: "DELETED_ATTENDANCE", resourceType: "ATTENDANCE" };
    }
    // HRMS - Leaves
    if (routeLower.includes("/employee/leaves")) {
        if (method === "PATCH" || method === "PUT") {
            if (((_a = req.body) === null || _a === void 0 ? void 0 : _a.status) === "Approved")
                return { action: "APPROVED_LEAVE", resourceType: "LEAVE" };
            if (((_b = req.body) === null || _b === void 0 ? void 0 : _b.status) === "Rejected")
                return { action: "REJECTED_LEAVE", resourceType: "LEAVE" };
        }
    }
    ...
    for (const [path, type] of Object.entries(configMap)) {
        if (routeLower.includes(path)) {
            if (method === "POST")
                return { action: `CREATED_${type}`, resourceType: type };
            if (method === "PUT" || method === "PATCH")
                return { action: `UPDATED_${type}`, resourceType: type };
            if (method === "DELETE")
                return { action: `DELETED_${type}`, resourceType: type };
        }
    }
...
const generateBusinessDescription = (action, resourceName, userName) => {
    const actionMap = {
...
const getResourceTypeFromRoute = (route) => {
    ...
    if (routeLower.includes("/lead-mentors"))
        return "LEAD_MENTOR";
    if (routeLower.includes("/super-admins"))
        return "SUPER_ADMIN";
    if (routeLower.includes("/schools"))
        return "SCHOOL";
    if (routeLower.includes("/modules"))
    ...
    if (routeLower.includes("/certificates"))
        return "CERTIFICATE";
    if (routeLower.includes("/notifications"))
        return "NOTIFICATION";
    if (routeLower.includes("/messages"))
        return "MESSAGE";
    if (routeLower.includes("/files"))
        return "FILE";
    if (routeLower.includes("/salary-structures"))
    ...
    if (routeLower.includes("/employee/leaves"))
        return "LEAVE";
    if (routeLower.includes("/designations"))
        return "DESIGNATION";
    if (routeLower.includes("/departments"))
        return "DEPARTMENT";
    if (routeLower.includes("/branches"))
        return "BRANCH";
    if (routeLower.includes("/companies"))
        return "COMPANY";
    if (routeLower.includes("/cost-centers"))
        return "COST_CENTER";
    if (routeLower.includes("/working-days"))
        return "WORKING_DAY";
    if (routeLower.includes("/policies"))
        return "POLICY";
    if (routeLower.includes("/job-openings"))
        return "JOB_OPENING";
    if (routeLower.includes("/candidates"))
        return "CANDIDATE";
    return "OTHER";
};
...
const activityLogger = async (req, res, next) => {
    ...
    if (req._activityLogApplied) {
        return next();
    }
    req._activityLogApplied = true;
    ...
    res.on('finish', async () => {
        ...
        try {
            ...
            const resourceName = ((_a = req.body) === null || _a === void 0 ? void 0 : _a.name) || ((_b = req.body) === null || _b === void 0 ? void 0 : _b.title) || ((_c = req.body) === null || _c === void 0 ? void 0 : _c.email) || null;
            const description = generateBusinessDescription(businessAction.action, resourceName, req.user.name || "Unknown User");
            const activityLog = new ActivityLog_1.default({
                ...
                errorMessage: statusCode >= 400 ? (responseBody === null || responseBody === void 0 ? void 0 : responseBody.message) || "Unknown error" : null,
                duration,
                metadata: {
...
const logActivity = async (userId, userEmail, userName, userRole, action, resourceType, description, details = {}, options = {}) => {
    try {
        const activityLog = new ActivityLog_1.default({
            userId,
            userEmail,
