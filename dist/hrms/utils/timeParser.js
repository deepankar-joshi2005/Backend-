...
exports.parseTimeStringToMinutes = parseTimeStringToMinutes;
exports.parseBreakWindowDurationMinutes = parseBreakWindowDurationMinutes;
/**
 ...
 */
function parseTimeStringToMinutes(raw) {
    if (!raw)
        return null;
    const str = raw.trim();
 ...
 */
function parseBreakWindowDurationMinutes(raw) {
    if (!raw)
        return null;
