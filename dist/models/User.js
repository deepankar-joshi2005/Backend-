...
exports.DESIGNATIONS = exports.ROLES = void 0;
...
exports.DESIGNATIONS = ["proprietor", "partner", "director", "authorized_signatory"];
const userSchema = new mongoose_1.default.Schema({
    ...
    role: { type: String, required: true, trim: true, enum: exports.ROLES },
    ...
    businessClientId: {
        ...
        validate: {
            validator(value) {
                if (["business_client_admin", "business_client_employee"].includes(this.role))
                    return !!value;
                return value === null || value === undefined;
            },
...
exports.default = mongoose_1.default.model("CaUser", userSchema, "users");
