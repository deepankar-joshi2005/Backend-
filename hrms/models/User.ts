...
const userSchema = new mongoose.Schema(
  {
    ...
    // Synthetic company-admin account CA-Management mints per company so CA
    // Firm Admin/Staff can open this company's real HRMS Payroll screens and
    // act on its behalf — never used for password login. See internalBridge.ts
    // issueCaProxySsoToken. Lets payroll runs be attributed to "CA" vs "Company".
    isCaProxy: { type: Boolean, default: false },
...
export default mongoose.model("User", userSchema, "hrms_users");
