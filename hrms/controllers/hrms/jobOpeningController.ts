 ...
 * ➕ Add Job Opening
 */
export const addJobOpening = async (req: Request, res: Response) => {
  try {
 ...
 */
export const getAllJobOpenings = async (_req: Request, res: Response) => {
  try {
 ...
 * ❌ Close Job Opening
 */
export const closeJobOpening = async (req: Request, res: Response) => {
  try {
 ...
 */
export const deleteJobOpeningById = async (req: Request, res: Response) => {
  try {
