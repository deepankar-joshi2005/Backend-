...
export const getMyTravelRequests = async (req: AuthRequest, res: Response) => {
  try {
...
/* ================= GET ALL (HR / ADMIN) ================= */
export const getAllTravelRequests = async (req: AuthRequest, res: Response) => {
  try {
    const requests = await TravelRequest.find()
...
/* ================= UPDATE (VIEW / EDIT) ================= */
export const updateTravelRequest = async (req: AuthRequest, res: Response) => {
  try {
...
/* ================= DELETE ================= */
export const deleteTravelRequest = async (req: AuthRequest, res: Response) => {
  try {
...
export const uploadTravelReceipt = async (req: any, res: Response) => {
  try {
