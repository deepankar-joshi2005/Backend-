...
/* ================= GET MY REQUESTS ================= */
export const getMyProfileUpdates = async (req: AuthRequest, res: Response) => {
  try {
...
/* ================= UPDATE (EDIT) ================= */
export const updateProfileUpdate = async (req: AuthRequest, res: Response) => {
  try {
    ...
    if (status === undefined) {
      ...
      if (
        request.employee.toString() !== req.user.id ||
...
/* ================= DELETE ================= */
export const deleteProfileUpdate = async (req: AuthRequest, res: Response) => {
  try {
